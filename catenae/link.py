...
class Link:
    ...
    def _set_connectors(self):
        try:
            self.aerospike = AerospikeConnector(self._aerospike_host, self._aerospike_port)
        except AttributeError:
            self.aerospike = None

        try:
            self.mongodb = MongodbConnector(self._mongodb_host, self._mongodb_port)
        except AttributeError:
            self.mongodb = None
